    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Tambah Wisata</h4>
            ...
            <form action="{{ route('admin.dashboard.wisatas.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary">Tambah Data Wisata</button>
                    </div>
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="deskripsi_wisata" rows="3" name="deskripsi_wisata" placeholder="Deskripsi Wisata">{{ old('deskripsi_wisata') }}</textarea>
