...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form action="{{ route('admin.dashboard.events.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary">Tambah Data Acara</button>
                    </div>
                            ...
                            <div class="col-lg-6">
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" id="nama_event" name="nama_event" placeholder="Nama Acara"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" id="lokasi_event" name="lokasi_event" placeholder="Lokasi Acara"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="deskripsi_event" rows="3" name="deskripsi_event" placeholder="Deskripsi Acara">{{ old('deskripsi_event') }}</textarea>
                            ...
                            <div class="col-lg-6">
                                <div class="mt-3 mt-lg-0">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="date" id="tanggal_event" name="tanggal_event" placeholder="Tanggal Acara"
