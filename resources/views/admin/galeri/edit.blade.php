    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Ubah Galeri</h4>
            ...
            <form action="{{ route('admin.dashboard.galeris.update', $galeri) }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="card">
                    <div class="card-header d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary">Simpan Perubahan Galeri</button>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" list="datalistWisatas" id="wisata" name="nama_wisata"
                                            autocomplete="off" value="{{ $galeri->wisata->nama_wisata }}"
                                            placeholder="Ketik untuk mencari wisata">
                                        <input type="text" id="wisata_id" name="wisata_id"
                                            value="{{ $galeri->wisata_id }}" style="display: none;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="deskripsi_galeri" rows="3" name="deskripsi_galeri"
                                            placeholder="Deskripsi Galeri">{{ old('deskripsi_galeri') ?? $galeri->deskripsi_galeri }}</textarea>
                                ...
                                <div class="mt-3 mt-lg-0">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" id="lokasi_galeri" name="lokasi_galeri"
                                            placeholder="Lokasi Galeri"
                                            value="{{ old('lokasi_galeri') ?? $galeri->lokasi_galeri }}">
                                        @error('lokasi_galeri')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" list="datalistEvents" id="event"
                                            value="{{ $galeri->event->nama_event }}" name="nama_event" autocomplete="off"
                                            placeholder="Ketik untuk mencari acara">
                                        <input type="text" id="event_id" name="event_id"
                                            value="{{ $galeri->event_id }}" style="display: none;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <img src="{{ $galeri->fotoGaleri() }}" alt="Gambar Galeri" class="img-fluid mt-2"
                                            style="width: 100px">
                                        @error('foto_galeri')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
